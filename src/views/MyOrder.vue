<template>
    <section class="container">
        <section class="content">
            ...
            <article id="product" class="shadow"><img src="@/components/img/headphones2.jpg" alt="Lunar 2"></article>
            <article id="checkoutCard" class="shadow">
                <div id="details">
                    <dl class="">
                        <dt>Product</dt>
                        <dd> <img id="thumbnail" src="@/components/img/headphones2.jpg" alt="Lunar 2"></dd>
                        <dt>Quantity</dt>
                ...
                <form action="">
                    ...
                    <button id="btnSubmit">Checkout</button>
                </form>
            </article>
        </section>
        <footer><p>Created by Elsie</p> </footer>
    </section>
    </template>
    <style scoped>
